...
class MMKVKotlinTest {
    ...
    fun testRemove() {
        ...
        mmkv.removeValueForKey("Int_1")
        mmkv.removeValueForKey("Long_1")
//        mmkv.removeValuesForKeys(listOf("Int_1", "Long_1"))
    ...
    fun testAllKeys() {
        ...
        mmkv.set("Int", Int.MAX_VALUE)
        mmkv.set("Boolean", true)

        assertEquals(mmkv.allKeys(), listOf("Boolean", "Int"))
    }
    ...
    fun testContainsKey() {
        ...
        assertEquals(mmkv.containsKey("String"), true)
        assertEquals(mmkv.containsKey(KEY_NOT_EXIST), false)
    }
